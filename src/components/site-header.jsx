...
export function SiteHeader() {
  return (
    <header
      className="flex h-[60px] rounded-sm bg-secondary-red shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
